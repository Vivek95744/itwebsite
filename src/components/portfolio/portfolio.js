...
Modal.setAppElement("#root"); // Set the app element to ensure accessibility
  ...
  return (
    <div>
                  ...
                  <div className="icon-container1">
                    <a className="icon1">
                      <svg
                        ...
                        height="0.6em"
                        viewBox="0 0 576 512"
                        onClick={() => handleImageClick(index)} // Open modal on eye click
                      >
      ...
      <Modal
        ...
        className="image-modal" // Add custom class for styling
        overlayClassName="image-modal-overlay" // Add custom overlay class for styling
      >
        <img
