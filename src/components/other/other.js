      ...
      <div className="other1">
        ...
        <div className="Others1">
          ...
          <div className="dimond">
            ...
            <div className="Texe">
              We have a team of personnel who work with the same goal in mind.
            </div>
            </div>
          ...
          <div className="dimond">
            ...
            <h3 className="texe">Business Identity</h3></div>
            <div><div className="Texe">
              We help to position you better in your business fraternity, walk
          ...
          <div className="dimond">
            ...
            <h3 className="texe">Excellence in leveraging new technologies</h3></div>
            <div><div className="Texe">
              Up-gradation of technology is inevitable and we prefer to be
          ...
          <div className="dimond">
            ...
            <h3 className="texe">Strong partnership with industry experts</h3></div>
            <div><div className="Texe">
              We understand the importance of a mix of knowledge and experience.
            </div>
          </div>
